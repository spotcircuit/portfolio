...
import { analyzePropertyByAddress } from '@/lib/utils/propertyAnalysis';
...
export const metadata: Metadata = {
  title: 'ADU Planner - Design Your Accessory Dwelling Unit',
  description: 'Plan and visualize your Accessory Dwelling Unit with our interactive tool. Get instant layout suggestions based on your property dimensions.',
  keywords: 'ADU, accessory dwelling unit, property planning, home addition, real estate',
};
